...
- **Sector RS rotation** — leading "where is leadership?" gauge: the 11 SPDR sectors ranked by relative strength vs SPY (3-month RS level) and whether that RS is **accelerating** (RRG-style momentum = this month's relative return − last month's), classified into four quadrants (Leading / Weakening / Improving / Lagging). Tells a momentum trader which groups to hunt in. Plain-English read on the Dashboard. Cached 6h. `GET /market/sectors`
