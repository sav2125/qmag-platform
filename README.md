...
- **Dashboard** — Market Positioning panel (regime dial), Market Breadth panel, Sector Rotation panel, scan controls, advanced filter panel, stats bar (Total / Grade A / EPs), full results table
